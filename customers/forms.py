...
class CustomerForm(forms.ModelForm):
    ...
    cpf = forms.CharField(max_length=255, label="", min_length=5, widget=forms.TextInput(
    ...
    address = forms.CharField(max_length=300, min_length=5, label="", widget=forms.TextInput(
    ...
    telephone = forms.CharField(max_length=255, min_length=10, label="", widget=forms.TextInput(
